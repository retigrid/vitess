INSERT INTO tbl_metering_group_data_5_min(created_ts, serial_id, group_id,
			phase_voltage_min, phase_voltage_max, phase_voltage_avg, phase_voltage_first, phase_voltage_last,
			line_voltage_min, line_voltage_max, line_voltage_avg, line_voltage_first, line_voltage_last,
			voltage_crest_factor_min, voltage_crest_factor_max, voltage_crest_factor_avg, voltage_crest_factor_first, voltage_crest_factor_last,
			phase_current_min, phase_current_max, phase_current_avg, phase_current_first, phase_current_last,
			current_crest_factor_min, current_crest_factor_max, current_crest_factor_avg, current_crest_factor_first, current_crest_factor_last,
			active_power_min, active_power_max, active_power_avg, active_power_first, active_power_last,
			reactive_power_min, reactive_power_max, reactive_power_avg, reactive_power_first, reactive_power_last,
			power_factor_min, power_factor_max, power_factor_avg, power_factor_first, power_factor_last,
			frequency_min, frequency_max, frequency_avg, frequency_first, frequency_last,
			thd_phase_voltage_min, thd_phase_voltage_max, thd_phase_voltage_avg, thd_phase_voltage_first, thd_phase_voltage_last,
			thd_phase_current_min, thd_phase_current_max, thd_phase_current_avg, thd_phase_current_first, thd_phase_current_last,
			temperature_min, temperature_max, temperature_avg, temperature_first, temperature_last,
			voltage_harmonics_min, voltage_harmonics_max, voltage_harmonics_avg, voltage_harmonics_first, voltage_harmonics_last,
			current_harmonics_min, current_harmonics_max, current_harmonics_avg, current_harmonics_first, current_harmonics_last,
			apparent_power_min, apparent_power_max, apparent_power_avg, apparent_power_first, apparent_power_last,
			inverter_conversion_efficiency_min, inverter_conversion_efficiency_max, inverter_conversion_efficiency_avg, inverter_conversion_efficiency_first, inverter_conversion_efficiency_last,
			electric_charge_min, electric_charge_max, electric_charge_avg, electric_charge_first, electric_charge_last,
			line_voltage_R_S_min, line_voltage_R_S_max, line_voltage_R_S_avg, line_voltage_R_S_first, line_voltage_R_S_last,
			line_voltage_S_T_min, line_voltage_S_T_max, line_voltage_S_T_avg, line_voltage_S_T_first, line_voltage_S_T_last,
			line_voltage_T_R_min, line_voltage_T_R_max, line_voltage_T_R_avg, line_voltage_T_R_first, line_voltage_T_R_last,
			accumulate_power_consumption_min, accumulate_power_consumption_max, accumulate_power_consumption_avg, accumulate_power_consumption_first, accumulate_power_consumption_last,
			dc_voltage_min, dc_voltage_max, dc_voltage_avg, dc_voltage_first, dc_voltage_last,
			dc_current_min, dc_current_max, dc_current_avg, dc_current_first, dc_current_last,
			dc_electric_power_min, dc_electric_power_max, dc_electric_power_avg, dc_electric_power_first, dc_electric_power_last,
			dc_ampere_min, dc_ampere_max, dc_ampere_avg, dc_ampere_first, dc_ampere_last,
			accumulate_dc_power_consumption_min, accumulate_dc_power_consumption_max, accumulate_dc_power_consumption_avg, accumulate_dc_power_consumption_first, accumulate_dc_power_consumption_last)
SELECT
